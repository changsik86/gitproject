 ...
 <BODY> 
   <FORM ACTION="join.jsp" METHOD=post name="form">   
	<TABLE>     
	  ...
	  <TR>   
	   <TD> 성별 </TD>   
	   <TD> <label><INPUT TYPE="radio" NAME="gender" VALUE="1" CHECKED>남자&nbsp;&nbsp;</label>       
	        <label><INPUT TYPE="radio" NAME="gender" VALUE="2">여자 </label></TD> 
	  </TR>
	  <TR>   
	   <TD> 취미 </TD>   
	   <TD> <label><INPUT TYPE="checkbox" NAME="hobby" VALUE="바둑">바둑&nbsp;&nbsp;</label>     
	        <label><INPUT TYPE="checkbox" NAME="hobby" VALUE="게임">게임&nbsp;&nbsp; </label>    
			<label><INPUT TYPE="checkbox" NAME="hobby" VALUE="낚시">낚시&nbsp;&nbsp;</label>     
			<label><INPUT TYPE="checkbox" NAME="hobby" VALUE="독서">독서 </label></TD>
	  </TR> 
	  <TR>   
	   <TD> 자기 소개하기</TD>   
