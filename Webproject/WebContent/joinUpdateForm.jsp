...
<body>
	...
	<table><tr><td colspan="2" align="center"><h2>회원 정보 수정</h2></td></tr>
		...
		<tr><td>이름</td>
			<td><input type="text" name="name" size="10" readonly value=${user.getName()}></td></tr>
		<tr><td>전화번호</td>
			<td><input type="text" name="tel" size="10" value=${user.getTel()}></td></tr>
		<tr><td>직업</td>
			<td><input type="text" name="job" size="10" value=${user.getJob()}></td></tr>
